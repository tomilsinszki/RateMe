ALTER TABLE rateable_collection_owner DROP FOREIGN KEY FK_5305B2EA76ED395;
ALTER TABLE rateable_collection_owner DROP INDEX UNIQ_5305B2EA76ED395;
ALTER TABLE rateable_collection_owner ADD KEY IDX_5305B2EA76ED395 (`user_id`);
ALTER TABLE rateable_collection_owner ADD CONSTRAINT `FK_5305B2EA76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
